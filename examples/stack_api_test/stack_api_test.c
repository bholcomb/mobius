...
int main() {
    ...
    mobius_stack_pushInt32(state, 100);
    mobius_stack_setGlobal(state, "test_var");
    
    mobius_stack_getGlobal(state, "test_var");
    int value = mobius_stack_asInt32(state, -1);
    printf("  Retrieved global 'test_var': %d\n", value);
    assert(value == 100);
    ...
    mobius_stack_pushInt32(state, 800);
    mobius_stack_setTableField(state, 0, "width");
    mobius_stack_pushInt32(state, 600);
    ...
    mobius_stack_pushInt32(state, 10);
    mobius_stack_setArrayElement(state, 0, 0);
    mobius_stack_pushInt32(state, 20);
    ...
    for (size_t i = 0; i < len; i++) {
        ...
        printf("  array[%zu] = %d\n", i, mobius_stack_asInt32(state, -1));
        mobius_stack_pop(state, 1);
    }
