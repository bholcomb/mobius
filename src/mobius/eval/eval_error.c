...
EvalResult make_error(Environment* env, const char* message, int line, int column) {
    ...
    result.error.stack_trace =  capture_stack_trace(env->current_context);  // No context available in basic make_error
...
EvalResult make_error_detailed(Environment* env, const char* message, const char* suggestion, 
    ...
    result.error.stack_trace = capture_stack_trace(env->current_context);;  // No context available in basic make_error_detailed
